...
public class CustomAutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    private List<CustomerList> CustomersLists;
    Context context;

    private final Object mLock = new Object();
    // private ArrayList<String> fullList;
    private List<CustomerList> mOriginalValues;
    ...
    public interface OnItemSelectClickListener {
        public void onItemSelectClicked(CustomerList item);
    }
    ...
    public CustomAutoCompleteAdapter(Context context, List<CustomerList> CustomersLists) {
        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private class ArrayFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                final List<CustomerList> values;
                ...
                final List<CustomerList> newValues = new ArrayList<>();
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            CustomersLists = (List<CustomerList>) results.values;
