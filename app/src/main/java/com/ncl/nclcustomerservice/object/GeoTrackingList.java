...
public class GeoTrackingList {
    ...
    @Expose
    public Object routeSnapAll;
    @SerializedName("route_snap_failure")
    @Expose
    public Object routeSnapFailure;
    @SerializedName("google_direction_all")
    @Expose
    public Object googleDirectionAll;
    @SerializedName("google_direction_failure")
    @Expose
    public Object googleDirectionFailure;
    ...
    @Expose
    public Object meterReadingCheckinImage;
    @SerializedName("meter_reading_checkin_text")
    @Expose
    public Object meterReadingCheckinText;
    @SerializedName("meter_reading_checkout_image")
    @Expose
    public Object meterReadingCheckoutImage;
    @SerializedName("meter_reading_checkout_text")
    @Expose
    public Object meterReadingCheckoutText;
