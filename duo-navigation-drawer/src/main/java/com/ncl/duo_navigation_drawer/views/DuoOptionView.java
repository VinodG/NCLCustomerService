package com.ncl.duo_navigation_drawer.views;
...
import com.ncl.duo_navigation_drawer.R;
...
//        setSelected(isSelected());
    ...
    public void setSelected(boolean selected,Context context) {
        if (selected) {
            mOptionViewHolder.mTextViewOption.setTypeface(Typeface.createFromAsset(context.getAssets(),"Montserrat-Medium.ttf"));
//mOptionViewHolder.optionLayout.setBackground(getResources().getDrawable(R.drawable.drawer_item_shape));
        } else {
            mOptionViewHolder.mTextViewOption.setTypeface(Typeface.createFromAsset(context.getAssets(),"Montserrat-Regular.ttf"));
mOptionViewHolder.optionLayout.setBackground(null);
        }
    }
...
//        mOptionViewHolder.mImageViewSelector.setAlpha(ALPHA_UNCHECKED);
    ...
    public void bind(String optionText, int resource, @Nullable Drawable selectorSideDrawable) {
        mOptionViewHolder.mTextViewOption.setText(optionText);
//        mOptionViewHolder.mTextViewOption.setAlpha(ALPHA_UNCHECKED);
        mOptionViewHolder.mIconOption.setImageResource(resource);
//        if (selectorDrawable != null) {
//            mOptionViewHolder.mImageViewSelector.setImageDrawable(selectorDrawable);
//        }
//        mOptionViewHolder.mImageViewSelector.setAlpha(ALPHA_UNCHECKED);
...
//        private ImageView mImageViewSelectorSide;
        ...
        OptionViewHolder(ViewGroup rootView) {
            mTextViewOption = (TextView) rootView.findViewById(R.id.nav_itemname);
            mIconOption = rootView.findViewById(R.id.nav_icon);
