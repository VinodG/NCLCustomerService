...
public class DuoDrawerLayout extends RelativeLayout {
    ...
    private static final String TAG_MENU = "menu_view";
    private static final String TAG_CONTENT = "content_view";
    ...
    private static final float MAX_ATTRIBUTE_MULTIPLIER = 50f;
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (xvel > 0 || xvel == 0 && mDragOffset > 0.5f && !isDrawerOpen()) {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (isDrawerOpen())
                mViewDragHelper.getCapturedView().setBackgroundDrawable(getResources().getDrawable(R.drawable.content_shadow));
            else {
                mViewDragHelper.getCapturedView().setPadding(0, 0, 0, 0);
                mViewDragHelper.getCapturedView().setBackgroundResource(0);
            }
